// Some of this code is taken from the glfw project here
// https://github.com/glfw/glfw/
//
// Copyright (c) Camilla Berglund <elmindreda@glfw.org>
//
// I have no idea how to 'cite' the source correctly at this point.
//
// Any changed code is copyright (c) 2016 Emil Hemdal
//
// The license is the zlib/libpng license for both glfw and my code. See below
// for details regarding the license.
//
...
/*
        ...
        printf(buf);
        printf("\n");
        sprintf(buf, "%d", wnd_width);
        printf(buf);
        printf("\n");
        //printf(wnd_width);

        snprintf(buf, 10, "%f", scale);
        printf(buf);
        printf("\n");
...
/*
        ...
        position = cosf((float) glfwGetTime() * 4.f) * 0.99f;
        glRectf(position - 0.01f, -1.f, position + 0.01f, 1.f);
*/
